...
## Overview
- **Positioning**: Senior Product Engineer & Technical Partner helping founders, executives, and growing businesses build high-revenue digital products, SaaS platforms, AI automations, and scalable mobile app backends.
- **Design System**: "Pristine Executive Modern" inspired by Stripe, Apple Pro, and Linear (Slate-White canvas `#f8fafc`, Royal Cobalt `#2563eb`, Emerald `#059669`).
- **Localization**: Instant zero-reload bilingual switcher (`EN` Executive & `ID` Casual-Marketing).
