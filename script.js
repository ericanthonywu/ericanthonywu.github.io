...
(function () {
  ...
  const translations = {
    en: {
      ...
      proc2_text: "Clean, modular builds delivered in focused feature milestones with continuous staging previews. You see real progress every single week.",
    ...
    id: {
      ...
      proc2_text: "Pengerjaan sistem secara transparan dan terukur dalam siklus milestone terarah. Kamu bisa pantau langsung progress-nya tiap minggu.",
      ...
      price1_desc: "Siklus sprint terarah untuk rilis MVP, integrasi chatbot AI sales, payment gateway Stripe, atau perbaikan performa sistem. Timeline dan ruang lingkup diestimasi tepat sesuai kompleksitas fitur yang kamu butuhkan.",
      ...
      price2_title: "0-to-1 Product Build",
      price2_floor: "Sesuai Roadmap Projek",
      price2_desc: "Pembangunan menyeluruh platform web SaaS atau mobile app dari desain UI, database, alur pembayaran, hingga live produksi. Terbagi dalam tahapan milestone yang jelas sesuai roadmap produk kamu.",
      ...
      price3_desc: "Pendampingan teknis senior khusus, iterasi fitur berkala, scaling kapasitas sistem, dan pemangkasan tagihan cloud bulanan secara berkelanjutan.",
