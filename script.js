...
(function () {
  ...
  const translations = {
    ...
    id: {
      ...
      proc2_text: "Pengerjaan sistem secara transparan dalam siklus milestone terarah dengan preview staging live, didukung update harian serta sesi presentasi progress mingguan atau bulanan.",
