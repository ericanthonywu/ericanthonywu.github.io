...
(function () {
  ...
  const translations = {
    en: {
      ...
      metric1_tag: "Full-Stack Engineering",
      metric1_title: "Custom Web Applications & MVPs",
      metric1_desc: "Design and build fast, responsive web platforms and client portals with clean architecture, ready to launch quickly and scale without technical debt.",

      metric2_stat: "Payments",
      metric2_tag: "Checkout & Revenue",
      metric2_title: "Seamless Payment & Transaction Flows",
      metric2_desc: "Integrate local and global payment gateways (Credit Cards, QRIS, Bank Transfers, Apple Pay) with automated invoicing to eliminate checkout friction and boost sales.",

      metric3_stat: "AI & Cloud",
      metric3_tag: "Automation & Infrastructure",
      metric3_title: "AI Automations & Server Optimization",
      metric3_desc: "Deploy 24/7 AI assistants to handle customer inquiries automatically and optimize cloud server setups to reduce monthly running costs while ensuring high uptime.",
    ...
    id: {
      ...
      metric1_stat: "Web & Apps",
      metric1_tag: "Pengembangan Web",
      metric1_title: "Aplikasi Web & Peluncuran MVP",
      metric1_desc: "Merancang dan membangun aplikasi web serta portal pelanggan yang cepat, responsif, dan siap rilis tanpa beban teknis di kemudian hari.",

      metric2_stat: "Payments",
      metric2_tag: "Integrasi Pembayaran",
      metric2_title: "Alur Pembayaran & Transaksi Mulus",
      metric2_desc: "Mengintegrasikan payment gateway lokal dan internasional (Kartu Kredit, QRIS, Transfer Bank, Apple Pay) dengan bukti transaksi otomatis agar checkout lancar dan penjualan meningkat.",

      metric3_stat: "AI & Cloud",
      metric3_tag: "Otomasi & Efisiensi",
      metric3_title: "Otomasi AI & Efisiensi Biaya Cloud",
      metric3_desc: "Menerapkan asisten AI 24/7 untuk melayani calon pembeli secara otomatis dan menata ulang infrastruktur server cloud agar biaya bulanan lebih hemat dengan uptime tinggi.",
